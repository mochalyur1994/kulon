		<div class="col-lg-8">
            <div class="panel panel-default" style="height:50px;">
				...
				<div class="showme hidden" style="position: absolute; left:20px; top:20px;">
					<div class="well">
				...
				<div class="pull-right" style="margin-right:10px; margin-top:7px;">
					<?php
						if ($chatrow['userid']==$_SESSION['id']){
                            ...
                            <a href="#share" data-toggle="modal" class="btn btn-primary">Share</a>
							<a href="#delete_room" data-toggle="modal" class="btn btn-danger">End Room</a>
							<?php
						}
						else{
							?>
